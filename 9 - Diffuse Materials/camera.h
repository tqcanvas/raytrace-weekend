...
private:
    ...
    void initialize() {
        ...
        // Coordinates of camera observer
        center = point3(0, 0, 0);
    ...
    color ray_color(const ray& r, int depth, const hittable& world) const {
        ...
        if (world.hit(r, interval(0.001, infinity), rec)) {
            // Get outgoing ray as a point on outfacing unit sphere where norm points to center
            // This results in a transformation where the light bounce is distributed approximately to cos of angle
            // to norm. Jacobian of the transformation shows this
            vec3 direction = rec.normal + random_unit_vector();
            // Create a ray from hit location with norm direction
            // Recurse and generate a color
